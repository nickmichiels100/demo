...
gaugeOverAllMeting = go.Figure(go.Indicator(
    mode = "gauge+number+delta",
    value = df1.iloc[0]['Bezettingsgraad']*100,
    domain = {'x': [0, 1], 'y': [0, 1]},
    title = {'text': "Overall bezettingsgraad %", 'font': {'size': 15, 'color':'black'}},
...
gaugeOverAllMeting.update_layout(paper_bgcolor = "white", font = {'color': "black", 'family': "Arial"})
