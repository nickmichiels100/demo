...
df = pd.read_excel('metingenFreesafdeling.xlsx', sheet_name='Gr Reichenbacher')

def barchartGrReichenbacher():
    return html.Div([dcc.Graph(id='graphGrReichenbacher', config={'displayModeBar': False} ,style={
                        # "width": "68%",
                        # "height": "800px",
    ...
    labels={"NettoDraaiUren":"Netto Draai Uren Grote Reichenbacher",
    "Dag":"Dagen gemeten"},           # map the labels of the figure
    title='Grote Reichenbacher draai uren', # figure title
