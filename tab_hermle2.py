...
df = pd.read_excel('metingenFreesafdeling.xlsx', sheet_name='Hermle 202')

def barchartHermle202():
    return html.Div([dcc.Graph(id='graphHermle202', config={'displayModeBar': False} ,style={
                        # "width": "68%",
                        # "height": "800px",
    ...
    labels={"NettoDraaiUren":"Netto Draai Uren Hermle 202",
    "Dag":"Dagen gemeten"},           # map the labels of the figure
    title='Hermle 202 draai uren', # figure title
